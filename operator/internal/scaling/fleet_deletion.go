...
func FindDeleteServer(ctx context.Context, fleet *networkv1alpha1.Fleet, servers *networkv1alpha1.ServerList, client client.Client, logger logr.Logger) (*networkv1alpha1.Server, error) {
	...
	if strategy == networkv1alpha1.OldestFirst {
		return getOldestServer(ctx, fleet, servers, deleteFirst, client, logger)
	}

	if strategy == networkv1alpha1.NewestFirst {
		return getNewestServer(ctx, fleet, servers, deleteFirst, client, logger)

	}
	return nil, fmt.Errorf("invalid scaling strategy: %s", strategy)
}

func getOldestServer(ctx context.Context, fleet *networkv1alpha1.Fleet, servers *networkv1alpha1.ServerList,
	deleteFirst bool, client client.Client, logger logr.Logger) (*networkv1alpha1.Server, error) {
...
func getNewestServer(ctx context.Context, fleet *networkv1alpha1.Fleet, servers *networkv1alpha1.ServerList,
	deleteFirst bool, client client.Client, logger logr.Logger) (*networkv1alpha1.Server, error) {
