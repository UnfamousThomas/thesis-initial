...
func (r *GameAutoscaler) Default() {
	gameautoscalerlog.Info("default", "name", r.Name)
...
// +kubebuilder:webhook:path=/validate-network-unfamousthomas-me-v1alpha1-gameautoscaler,mutating=false,failurePolicy=fail,sideEffects=None,groups=network.unfamousthomas.me,resources=gameautoscalers,verbs=create;update,versions=v1alpha1,name=vgameautoscaler.kb.io,admissionReviewVersions=v1

var _ webhook.Validator = &GameAutoscaler{}

// ValidateCreate implements webhook.Validator so a webhook will be registered for the type
func (r *GameAutoscaler) ValidateCreate() (admission.Warnings, error) {
	gameautoscalerlog.Info("validate create", "name", r.Name)
...
func (r *GameAutoscaler) ValidateUpdate(old runtime.Object) (admission.Warnings, error) {
	gameautoscalerlog.Info("validate update", "name", r.Name)
...
func (r *GameAutoscaler) ValidateDelete() (admission.Warnings, error) {
	gameautoscalerlog.Info("validate delete", "name", r.Name)
